console.log("============================================================================================")
console.log("                           Union Types Exercise                                             ")
console.log("============================================================================================")
...
let highScore : number | boolean = false;
...
let stuff : (number | string)[] = ["a", "b", "c", "d"];
...
let colors: (RGB | HSL)[] = [{r: 1, g: 2, b: 3}, {r: 1, g: 2, b: 3}, {h: 7, s:8, l: 9}]
...
function greet(input: string | string[]) {
    if (typeof input === "string")
        ...
        input.forEach(i => console.log(`Hello, ${i}`))
}